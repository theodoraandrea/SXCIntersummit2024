        ...
        <div>
            ...
            <section className="bg-primary-4 grid grid-cols-[auto,1fr] py-12">
                <div className='flex items-center justify-center ml-36 w-28 h-28'>
                    <img src={Profile} alt="Profile" className="w-24 h-24 rounded-full mb-4" />
                </div>
            ...
            <section className="bg-primary-1 py-8 h-screen">
                <div className="container mx-auto px-6 md:px-12">
                    <div className="flex justify-center space-x-6 mb-8">
                        <button 
                            className={`text-lg font-semibold ${activeTab === 'events' ? 'text-yellow-500 border-b-4 border-yellow-500' : 'text-gray-500'}`}
                            onClick={() => setActiveTab('events')}
                        >
                            Events
                        </button>
                        <button 
                            className={`text-lg font-semibold ${activeTab === 'competitions' ? 'text-yellow-500 border-b-4 border-yellow-500' : 'text-gray-500'}`}
