...
const MemberForm = ({ formData, handleChange }) => (
    <div>
        ...
        {[
            ...
            { label: 'National Student Identification Number', name: 'studentId-member', type: 'text' },
            { label: 'Student ID Card', name: 'studentCard-member', type: 'file' },
            { label: 'Proof of Following @sxcintersummit and @sxcintersummitcompetition Instagram Account', name: 'proofFollow-member', type: 'file' },
            { label: 'Proof of Twibbon Post', name: 'proofTwibbon-member', type: 'file' },
            { label: 'Proof of Sharing Instagram Story Posters', name: 'proofStory-member', type: 'file' },
            { label: 'Proof of Sharing Posters to 3 Whatsapp Group', name: 'proofWhatsapp-member', type: 'file' }
        ].map((field) => (
...
const FutureCEOPage = () => {
    const [formData, setFormData] = useState({
        'fullName-member': '', 'gender-member': '', 'school-member': '', 'phone-member': '', 'email-member': '', 'studentId-member': '', 'studentCard-member': null, 'proofFollow-member': null, 'proofTwibbon-member': null, 'proofStory-member': null, 'proofWhatsapp-member': null,
